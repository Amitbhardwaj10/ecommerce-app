...
function Wishlist() {
	...
	return (
		<div className="mx-auto xl:max-w-7xl px-2 sm:px-5 min-h-screen">
			...
			<div className="grid w-full justify-items-center md:justify-items-start my-11 grid-cols-2 gap-x-1 sm:gap-x-3 gap-y-1 sm:gap-y-6 sm:grid-cols-2 md:grid-cols-3 lg:gap-x-16 xl:grid-cols-4 px-auto">
			...
			<div>
				{wishlistItems.length === 0 && (
					<div className="text-center">
						...
						<img className="w-52 md:w-64 mx-auto" src={wishlistImage} alt="" />
						<button
